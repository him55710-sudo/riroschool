...
export declare class LocalStorageAdapter implements StorageAdapter {
    ...
    uploadFile(jobId: string, filename: string, buffer: Buffer, _contentType: string): Promise<string>;
    getSignedUrl(storageKey: string): Promise<string>;
}
export declare class S3CompatibleAdapter implements StorageAdapter {
    uploadFile(jobId: string, filename: string, _buffer: Buffer, _contentType: string): Promise<string>;
    getSignedUrl(storageKey: string): Promise<string>;
}
